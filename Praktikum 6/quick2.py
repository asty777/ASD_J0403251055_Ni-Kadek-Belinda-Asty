...
def partition(data, first, last):
    ...
    while not done:
        ...
        while leftmark <= rightmark and data[leftmark] >= pivotvalue: #diubah jadi descending
            leftmark = leftmark + 1

        while rightmark >= leftmark and data[rightmark] <= pivotvalue: #diubah jadi descending
