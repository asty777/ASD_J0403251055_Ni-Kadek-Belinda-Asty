...
def dijkstra(graph, start):
    ...
    while priority_queue:
        ...
        # Jika jarak lebih besar dari data sebelumnya, dilewati
...
# 4. Karena jalur A -> C -> D memiliki total bobot 3,
#    sedangkan A -> B -> D memiliki total bobot 9
# 5. priority_queue berfungsi memilih node dengan
#    jarak terkecil terlebih dahulu
# 6. Karena bobot negatif dapat menyebabkan hasil
